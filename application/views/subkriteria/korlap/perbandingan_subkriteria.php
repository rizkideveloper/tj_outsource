...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?= base_url('Subkriteria_korlap'); ?>">Subkriteria Koordinator Lapangan</a></li>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="s4s7" style="width:80px;">
                                        <option value=""></option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                        <option value="4">4</option>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="s5s7" style="width:80px;">
                                        <option value=""></option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                        <option value="4">4</option>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="s6s7" style="width:80px;">
                                        <option value=""></option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                        <option value="4">4</option>
                            ...
                            <tr>
                                ...
                                <td><input id="s7s4" type="number" style="width:80px;  background-color:lightgray" readonly></td>
                                <td><input id="s7s5" type="number" style="width:80px;  background-color:lightgray" readonly></td>
                                <td><input id="s7s6" type="number" style="width:80px;  background-color:lightgray" readonly></td>
...
<script>
    ...
    function normalisasi() {
        ...
        s4s7 = parseInt($('#s4s7').val())
        s5s7 = parseInt($('#s5s7').val())
        s6s7 = parseInt($('#s6s7').val())
        ...
        if (cr < 0.1) {
            ...
            $('#kesimpulan1').html('Karena nilai CR < 0.1 maka dapat disimpulkan bahwa nilai priotas di tabel normalisasi dapat dijadikan acuan')
    ...
    function swall($title) {
        Swal.fire({
            ...
            location.href = '<?= base_url('Subkriteria_korlap') ?>'
        })
    ...
    function simpan() {
        ...
        $.ajax({
            method: 'POST',
            url: '<?= base_url('Subkriteria_korlap/simpan_bobot')  ?>',
            data: {
                prs1: prs1,
                prs2: prs2,
                prs3: prs3,
